...
if __name__=="__main__":
    ...
    parser.add_argument('-rules', dest='rules', help='path to json file containing rules')
    parser.add_argument('-output', dest='output', help='path of file to write boilerplate code to')
    args = parser.parse_args()
    if not args.rules or not args.output:
        print "rules:%s\noutput:%s" % (args.rules, args.output)
    else:
