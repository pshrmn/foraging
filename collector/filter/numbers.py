...
def clean_number_string(num):
    ...
    :param string num: string representing a number,
        potentially with commas in it
    """
    return re.sub(",", "", num)
...
def currency_from_string(num):
    """
    takes a string representing a number and returns a new string formatted
...
def currency_from_number(num):
    """
    takes a float/int and returns a string representing the number
